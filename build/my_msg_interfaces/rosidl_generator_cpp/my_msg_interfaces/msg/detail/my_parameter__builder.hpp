...
class Init_MyParameter_phase
{
public:
  explicit Init_MyParameter_phase(::my_msg_interfaces::msg::MyParameter & msg)
  : msg_(msg)
  {}
  Init_MyParameter_time phase(::my_msg_interfaces::msg::MyParameter::_phase_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_MyParameter_phase offset(::my_msg_interfaces::msg::MyParameter::_offset_type arg)
  {
    msg_.offset = std::move(arg);
    return Init_MyParameter_phase(msg_);
  }
